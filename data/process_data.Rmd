...
So to remedy this, let's start by emplicitly encoding the task order:
...
Before saving, change level names to English:

```{r}
d_fc_full$Task <- ifelse(d_fc_full$Task == "form", "Shape", "Category")
```
